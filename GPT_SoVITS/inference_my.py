...
def get_tts_wav_by_params(gpt_path_input, sovits_path_input, ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut=i18n("不切")):
    global gpt_path
    global sovits_path
    gpt_path = gpt_path_input
    sovits_path = sovits_path_input
    change_sovits_weights(sovits_path)
    change_gpt_weights(gpt_path)
    result_array = []
    for item in get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut):
